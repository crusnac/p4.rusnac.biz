...
<div class="alert alert-danger fade in">
	...
	<strong><i class="fa fa-exclamation-triangle"></i> The address you entered is invalid!</strong>  Please try again!
</div>
<?php endif; ?>
<?php if(isset($_GET['user-does-no-exists'])): ?>
<div class="alert alert-danger fade in">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong><i class="fa fa-exclamation-triangle"></i> That user does not exist. </strong>  You can try again or <a class="alert-link" href="/users/signup/">register</a> as a new user.
</div>
<?php endif; ?>
