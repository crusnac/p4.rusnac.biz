...
<div class="alert alert-danger fade in">
        ...
        <strong><i class="fa fa-exclamation-triangle"></i> I am unable to process your registration!</strong>  Please enter in all the appropriate information to continue. 
</div>
<?php endif; ?>
...
<div class="alert alert-danger fade in">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <strong><i class="fa fa-exclamation-triangle"></i> I am unable to process your registration.  Your E-mail Address is not correct!</strong>  <br />Please used a standard email convention. i.e: name@domain.com
</div>
<?php endif; ?>
...
<div class="alert alert-danger fade in">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <strong><i class="fa fa-exclamation-triangle"></i> Your password don't match!</strong>  Please try your registration again.
</div>
<?php endif; ?>
