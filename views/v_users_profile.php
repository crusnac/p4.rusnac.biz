...
<div class="alert alert-success fade in">
	...
	<strong><i class="fa fa-exclamation-triangle"></i> Your profile has been successfully updated!</strong>
</div>
<?php endif; ?>
<?php if(isset($_GET['password-updated'])): ?>
<div class="alert alert-success fade in">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong><i class="fa fa-exclamation-triangle"></i> Your password has been successfully updated!</strong>
</div>
<?php endif; ?>
<?php if(isset($_GET['password-match'])): ?>
<div class="alert alert-warning fade in">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong><i class="fa fa-exclamation-triangle"></i> Your passwords don't match!</strong> Please try again.
</div>
<?php endif; ?>
<?php if(isset($_GET['empty-password'])): ?>
<div class="alert alert-warning fade in">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong><i class="fa fa-exclamation-triangle"></i> Your Password is empty!</strong> Please try again, but this time fill something in.
</div>
<?php endif; ?>
<?php if(isset($_GET['login-success'])): ?>
<div class="alert alert-success fade in">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong><i class="fa fa-exclamation-triangle"></i> You have successfully Logged in!</strong>
</div>
<?php endif; ?>
<?php if(isset($_GET['partial-form'])): ?>
<div class="alert alert-danger fade in">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong><i class="fa fa-exclamation-triangle"></i> I was unable to update your profile!</strong> Please fill in all the appropriate information.
</div>
<?php endif; ?>
<!-- End Notices -->
...
<form method='POST' action='/users/p_profile'>
	...
	<label><small>Your Employee ID</small></label>
	<input type="text" name="employee_id" class="form-control" placeholder="Your Employee ID" value="<?php echo $value['employee_id']; ?>">
	...
	<button class="btn btn-primary">Update My Profile</button> <a data-toggle="modal" href="#reset-password" class="btn btn-success">Reset Password</a> 
</form>
			...
			<div class="modal-body">
				<form method="POST" action="/users/p_profile_password">
					...
					<div class="form-group">
						...
						<input type="password" id="password_check" name="password_check" required class="form-control">
					</div>
