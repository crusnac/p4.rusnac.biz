...
# What is the name of this app?
	define('APP_NAME', 'Web Application Assessment Report Management Platform');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'claudiu.rusnac@xerox.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'claudiu.rusnac@xerox.com'); 

# Default DB name for this app
	define('DB_NAME', 'report-engine'); 
