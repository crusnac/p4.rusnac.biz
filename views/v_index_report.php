...
<div class="row">
	...
	<div class="col-md-3">
		...
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		    <center><h1><span class="label label-default critical-badge"><i class="fa fa-exclamation-triangle"></i> <?php print $report[0]['vulns_critical']; ?></span></h1></center>
		  </div>
		</div>
	...
	<div class="col-md-3">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		    <center><h1><span class="label label-default high-badge"><?php print $report[0]['vulns_high']; ?></span></h1></center>
		  </div>
		</div>
	...
	<div class="col-md-3">
		...
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		    <center><h1><span class="label label-default medium-badge"><?php print $report[0]['vulns_medium']; ?></span></h1></center>
		  </div>
		</div>
	...
	<div class="col-md-3">
		...
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		    <center><h1><span class="label label-default low-badge"><?php print $report[0]['vulns_low']; ?></span></h1></center>
		  </div>
		</div>
