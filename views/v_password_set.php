...
<div class="alert alert-danger fade in">
	...
	<strong><i class="fa fa-exclamation-triangle"></i> The password you entered is empty!</strong>  Please try again!
</div>
<?php endif; ?>
<?php if(isset($_GET['password-match'])): ?>
<div class="alert alert-danger fade in">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong><i class="fa fa-exclamation-triangle"></i> Your passwords don't match! </strong>  You can try again.
</div>
<?php endif; ?>
<?php if(isset($_GET['password-reset'])): ?>
<div class="alert alert-success fade in">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<strong><i class="fa fa-exclamation-triangle"></i> Your user password has been changed!</strong>  Login to continue. 
</div>
<?php endif; ?>
